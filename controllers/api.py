...
def leave_group():
    ...
    profile_email = request.vars.profile_email
    crowd_mem_num = int(request.vars.crowd_mem_num)
    if crowd_mem_num == 1:
        db.crowd.update_or_insert(
            (db.crowd.id == crowd_id),
            crowd_member_1=""
        )
    elif crowd_mem_num == 2:
        db.crowd.update_or_insert(
            (db.crowd.id == crowd_id),
            crowd_member_2=""
        )
    elif crowd_mem_num == 3:
        db.crowd.update_or_insert(
            (db.crowd.id == crowd_id),
            crowd_member_3=""
        )
    elif crowd_mem_num == 4:
        db.crowd.update_or_insert(
            (db.crowd.id == crowd_id),
            crowd_member_4=""
        )
    elif crowd_mem_num == 5:
        db.crowd.update_or_insert(
            (db.crowd.id == crowd_id),
            crowd_member_5=""
        )
    elif crowd_mem_num == 6:
        db.crowd.update_or_insert(
            (db.crowd.id == crowd_id),
            crowd_member_6=""
        )
    elif crowd_mem_num == 7:
        db.crowd.update_or_insert(
            (db.crowd.id == crowd_id),
            crowd_member_7=""
        )
    elif crowd_mem_num == 8:
        db.crowd.update_or_insert(
            (db.crowd.id == crowd_id),
            crowd_member_8=""
        )
    elif crowd_mem_num == 9:
        db.crowd.update_or_insert(
            (db.crowd.id == crowd_id),
            crowd_member_9=""
        )
    elif crowd_mem_num == 10:
        db.crowd.update_or_insert(
            (db.crowd.id == crowd_id),
            crowd_member_10=""
        )
